...
<table>
  <tr>
    <td><a href="ppp1.jsp" class="lin"><img src="back.jpg" class="back"></a></td>
...
<tr><td>Worker ID:</td><td><jsp:getProperty name="spc" property="workerid"></jsp:getProperty></td></tr>
...
<tr><td>Company:</td><td><jsp:getProperty name="spc" property="com"></jsp:getProperty></td></tr>
<tr><td>City:</td><td><jsp:getProperty name="spc" property="city"></jsp:getProperty></td></tr>
</table>
</center>
<%
