...
<table>
  <tr>
    <td><a href="register1.jsp" class="lin"><img src="back.jpg" class="back"></a></td>
...
<div class="logo"><b>PS</b> CO<b>R</b>PS</div><br>
        <h1 style="text-align:center;color: blanchedalmond;">Worker Data Saved Successfully in Database!..</h1>
    <form>
        <table border="1" style="width:60%;margin-left:auto;margin-right:auto;background-color:rgb(196, 196, 247);">
            ...
            <tbody>
                <c:forEach var='row' items="${rs.rows}">
                    <tr>
                         <td><c:out value='${row.workerid}'/></td>
                        ...
                        <td><c:out value='${row.com}'/></td>
                        <td><c:out value='${row.city}'/></td>
                        <td>
  						<input type="button" class="btn" value="Select"  onclick="editworker(<c:out value='${row.workerid}'/>, '<c:out value='${row.name}'/>', '<c:out value='${row.gender}'/>','<c:out value='${row.email}'/>','<c:out value='${row.mobile}'/>','<c:out value='${row.course}'/>','<c:out value='${row.year}'/>','<c:out value='${row.com}'/>','<c:out value='${row.city}'/>')">
                                                 </td>
...
<center>
 <fieldset class="box"style="border: 1;border-radius: 50px;width: 20px;border-color:darkgray,lightblue,lightcoral,lightgreen,lightpink;width: 400px;background-color: midnightblue;">
    <form action="update1.jsp">
        <h2 style="position:relative;color: blanchedalmond;">Worker Updation Form</h2>
        <center>
        <table style="position:relative;" ><b>
            <tr>
                <td style="color: azure;"><b>Workerid  :</b></td>
                <td><input type="text" name="workerid" id="editWorkerid" ></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="color: azure;"><b>Company :</b></td>
                <td><input type="text" name="com" id="editCom"></td>
            </tr>
            <tr>
             ...
             <input class="btn" type="submit" value="Update" style="width:80px;height:40px; position:relative;background-color: rgb(196, 196, 247) ;">
        
    </form>
</fieldset>
</center>
    <script>
    function editworker(workerid, name, gender, email, mobile, course, year, com, city) {
        ...
        document.getElementById("editCom").value = com;
