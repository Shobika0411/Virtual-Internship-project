...
<body style="background-color: rgb(41,41,143);">
    ...
    <h1 style="font-family:Baskerville Old Face ;color: rgb(203, 235, 243);text-align: center;">ARTIFICIAL INTELIGENCE</h1>
    ...
    <ul type="square">
    <li>AI problems</li>
    <li> foundation of AI and history of AI intelligent agents</li>
        <li> Agents and Environments</li>
            <li> the concept
                of rationality</li>
                <li> the nature of environments</li>
                    ...
                    <li>structure of agents</li>
                        ...
                        <li> uniformed search strategies</li>
                        <li>Breadth first search</li>
                        <li>depth first Search</li>
                        <li>Search with partial information (Heuristic search) Hill climbing</li>
                        <li> A* ,AO* Algorithms</li>
</ul>
</div>
</body>
</html>