...
<body style="background-color: rgb(41,41,143);">
    ...
    <h1 style="font-family:Baskerville Old Face ;color: rgb(203, 235, 243);text-align: center;">HUMAN RERSOURCES</h1>
    ...
    <ul type="square">
    <li>Legislation on Labor Relations and Industrial Relations</li>
    <li>Environment of Business</li>
        <li>Visual Communication</li>
            <li>Management of Human Resources</li>
                <li>Ethnography & People Design</li>
                    <li>Strategic Planning</li>
                    <li>HR Audit and Human Capital Management</li>
                        <li>Planning and Development of Human Resources</li>
                        <li>Information System for Human Resources</li>
                        <li>Advertising Management</li>
                        <li>Training and Development</li>
                        <li>International Human Resource Management </li>
                        <li>Advanced Manpower Planning </li>
                        <li>Organizational Change and Development</li>
                        <li>Human Resource Management in Service Sector</li>
</ul>
</div>
</body>
</html>