...
<table>
  <tr>
    ...
    <div class="logo"><b>PS</b> CO<b>R</b>PS</div><br><br>
<center><h2 class="color-changing-text"style="color: rgb(253, 249, 12);font-family:Segoe Print ;font-size: 40px;"><b>WORKER REGISTRATION FORM</b></h2>

<fieldset class="box" style="width:500px;color:white;text-align:left;border-radius: 5px;">

<b><form action="insert1.jsp">
    <center><table>
<tr><td><label style="color:#d3c8f8;">WORKER ID</td></label>
<td>:</td><td><input type="text" name="workerid"><br></td></tr>

<tr><td><label style="color:#d3c8f8;">NAME</label></td>
    <td>:</td>
...
<tr><td><label style="color:#d3c8f8;">YEAR OF EXPERIANCE</td></label>
    <td>:</td>
    <td><input type="text" name="year"></td></tr>
<tr><td><label style="color:#d3c8f8;">COMPANY NAME</td></label>
    <td>:</td>
    <td><input type="text" name="com"></td></tr>
