...
<body style="background-color: rgb(41,41,143);">
    ...
    <h1 style="font-family:Baskerville Old Face ;color: rgb(203, 235, 243);text-align: center;">EVENT MANAGEMENT</h1>
    ...
    <ul type="square">
    <li>Event Planning & Venue Management</li>
            ...
            <li>Management of Human Resources</li>
                <li>Introduction to Event Management</li>
                    ...
                    <li>Consumer Behavior</li>
                        <li>Legal Aspects of Event Management</li>
                        ...
                        <li>Event Cost Accounting & Finance Management</li>
</ul>
</div>
</body>
</html>