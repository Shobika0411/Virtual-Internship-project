...
<body style="background-color: rgb(41,41,143);">
    ...
    <h1 style="font-family:Baskerville Old Face ;color: rgb(203, 235, 243);text-align: center;">UI AND UX DESIGN</h1>
    ...
    <div class="box"  id="link"><a href="ppp.jsp" style="color: blue;">Click Here to register--></a></div>
    <div>
    <h3 style="font-family: Engravers MT;color: beige;font-size: 35px;">SYLLABUS</h3>
    <ul type="square">
    <li>Fundamendals of Design</li>
    <li>Principles of Design</li>
        <li>Visual Communication</li>
            <li>Empathy & User Study</li>
                <li>Ethnography & People Design</li>
                    <li>Service Design</li>
                    <li>Design Thinking</li>
                        <li>Information & Data Study</li>
                        <li> Elements of Design</li>
                        <li>History of art design and architecture</li>
                        <li>Basics of Design (Colour)</li>
                        <li>Consumer Interface Design</li>
                        <li>Introduction to Engineering Design Principles</li>
                        <li>Fundamentals of Design (Materials)</li>
